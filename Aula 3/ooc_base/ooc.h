...
//  Ex:
//      p_string_t var = new(string_c, class);
//      ...
//      delete(var);
...
#define CLONE_C(pointer_, type_) (type_*) ooc_safeClone(pointer_, sizeof(type_))
...
#define M_CLONE_DEF   void*, ooc_clone
#define M_CLONE_ARG   void* _self
#define M_CLONE_PARAM       _self
DYNAMIC_METHOD_HEADER(M_CLONE);
...
inline int ooc_putObject(const void* self_){
